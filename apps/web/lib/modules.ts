...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    dot: 'bg-violet-500',
    what: 'Give it a GitHub pull request and it fetches the diff and asks Claude for a standardised, three-section report — What’s Changed (a QA-perspective summary), What’s Impacted (the blast radius: impacted areas, files, and user flows), and a Testing checklist (what to test, ranked by risk) — cross-linked to any existing scanner findings on the same area.',
    how: [
      'Parses the PR URL and fetches the diff + changed files from the GitHub API.',
      'Sends the bounded context to Claude for a schema-validated, three-section report.',
      'Summarises what changed, then maps the blast radius across files and user flows.',
      'Produces a risk-ranked testing checklist, cross-linked to existing findings.',
    ],
    use: { label: 'Analyse a pull request', href: '/impact' },
    codes: ['what’s changed', 'what’s impacted', 'testing checklist', 'risk-ranked'],
  },
  {
    slug: 'testcases',
